...
SELECT 
    ...
    (dwp.total_gas / 24) * dwp.well_uptime_hours AS total_gas,
    dwp.gaslift_gas AS gaslift_gas,
    (dwp.total_gas / 24) * dwp.well_uptime_hours - dwp.gaslift_gas AS produced_gas,
    ...
    dwp.oil_loss_ton AS oil_loss_ton,
