...
CREATE TABLE `daily_well_parameters` (
  ...
  `oil_loss_ton` decimal(10,1) DEFAULT NULL,
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
-- Dump completed on 2025-01-28 23:07:06
